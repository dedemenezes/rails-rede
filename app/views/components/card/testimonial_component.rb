...
module Card
  class TestimonialComponent < ApplicationComponent
    ...
    def view_template
      div(
        class: "testimonial d-flex flex-column align-items-start flex-md-row #{if index.odd?
                                                                                 'flex-md-row-reverse'
                                                                               end} shadow-elevation-2",
        id: dom_id(collaborator)
      ) do
        image_tag(collaborator.avatar, width: '100px', height: '100px',
                                       class: "testimonial__avatar rounded-circle fit--cover flex-shrink-0 mb-3 mb-md-0 mx-auto")
